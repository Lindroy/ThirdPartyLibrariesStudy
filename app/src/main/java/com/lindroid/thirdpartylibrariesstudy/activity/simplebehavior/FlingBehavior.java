 ...
 * @author Lin
 * @date 2018/1/4
 * @function 自定义AppBarLayout.Behavior，用于解决AppBarLayout和NestedScrollView一起使用时，NestedScrollView没有Fling效果的问题。
 * http://blog.csdn.net/joye123/article/details/53073638
 */
